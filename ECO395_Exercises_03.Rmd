...
lm_green = lm(revenue ~ . - CS_PropertyID - Rent - leasing_rate - green_rating, data=green_train)

# lm_green_modified = lm(revenue ~ . - Rent - leasing_rate - LEED - Energystar + Gas_Costs:cd_total_07 + Electricity_Costs:hd_total07 + Gas_Costs:class_a + Gas_Costs:class_b + Electricity_Costs:class_a + Electricity_Costs:class_b + Electricity_Costs:age + Electricity_Costs:age, data=green_train)
...
green.forest_modified = randomForest(revenue ~ . - CS_PropertyID - Rent - leasing_rate - LEED - Energystar + Gas_Costs:cd_total_07 + Electricity_Costs:hd_total07 + Gas_Costs:class_a + Gas_Costs:class_b + Electricity_Costs:class_a + Electricity_Costs:class_b + Electricity_Costs:age + Electricity_Costs:age, data = green_train, importance = TRUE, na.action = na.omit)

green.forest_modified2 = randomForest(revenue ~ . - CS_PropertyID - Rent - leasing_rate - LEED - Energystar - Electricity_Costs:hd_total07 + Gas_Costs:class_a + Gas_Costs:class_b + Gas_Costs:City_Market_Rent + Gas_Costs:stories + Gas_Costs:amenities + Electricity_Costs:class_a + Electricity_Costs:class_b + Electricity_Costs:age + Electricity_Costs:age  + Electricity_Costs:City_Market_Rent + Electricity_Costs:stories + Electricity_Costs:amenities, data = green_train, importance = TRUE, na.action = na.omit)

### Gradient boost
green_boost = gbm(revenue ~ . - CS_PropertyID - Rent - leasing_rate - LEED - Energystar + Gas_Costs:cd_total_07 + Electricity_Costs:hd_total07 + Gas_Costs:class_a + Gas_Costs:class_b + Gas_Costs:City_Market_Rent + Gas_Costs:stories + Gas_Costs:amenities + Electricity_Costs:class_a + Electricity_Costs:class_b + Electricity_Costs:age + Electricity_Costs:age  + Electricity_Costs:City_Market_Rent + Electricity_Costs:stories + Electricity_Costs:amenities, data = green_train, interaction.depth=4, n.trees=500, shrinkage=.05)

rmse(lm_green, green_test)
rmse(lm_green_modified, green_test)
rmse(green.tree_prune, green_test)
rmse(green.forest, green_test)
rmse(green.forest_modified, green_test)
rmse(green.forest_modified2,green_test)
...
lm_housing_modified = lm(medianHouseValue ~ . - latitude - longitude + population:medianIncome + (housingMedianAge)^2, data=housing_train)

rmse(lm_housing, housing_test)
rmse(lm_housing_modified, housing_test)
summary(lm_housing_modified)
...
housing.forest2 = randomForest(medianHouseValue ~ . - latitude - longitude + population:medianIncome + (housingMedianAge)^2, data = housing_train, importance = TRUE)

#Gradient boosting
housing_boost = gbm(medianHouseValue ~ . - latitude - longitude + population:medianIncome + (housingMedianAge)^2, data = housing_train, interaction.depth=4, n.trees=500, shrinkage=.05)
...
rmse(housing.forest2, housing_test)
rmse(housing_boost, housing_test)
plot(housing.forest2)
